...
func (_m *Client) DoHTTPRequest(request *http.Request) (int, []byte, error) {
...
func (_m *Client) GetContent(URL string, setters ...network.GetContentSetter) ([]byte, int, error) {
	...
	var r0 []byte
	if rf, ok := ret.Get(0).(func(string, ...network.GetContentSetter) []byte); ok {
		r0 = rf(URL, setters...)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]byte)
	...
	var r1 int
	if rf, ok := ret.Get(1).(func(string, ...network.GetContentSetter) int); ok {
		r1 = rf(URL, setters...)
	} else {
		r1 = ret.Get(1).(int)
	}
	...
	var r2 error
	if rf, ok := ret.Get(2).(func(string, ...network.GetContentSetter) error); ok {
		r2 = rf(URL, setters...)
	} else {
		r2 = ret.Error(2)
	}
